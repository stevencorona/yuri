...
typedef struct eri {
   ...
   * The manager is actually only destroyed when all the instances are
   * destroyed. When destroying the manager a warning is shown if the manager
   * has missing/extra entries.
   * @param self Interface of the entry manager
   */
