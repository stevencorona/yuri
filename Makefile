...
CFLAGS = -DDEBUG -g3 -fno-stack-protector -ffast-math -Wall -Wno-sign-compare -DFD_SETSIZE=1024 -DLOGGING_ENABLED -I../common -I/usr/include/mysql -I/usr/include/lua5.1 -I/usr/local/zlib/include
